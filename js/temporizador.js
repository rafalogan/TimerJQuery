(function ($) {
    $.fn.temporizador = function (opicoes) {
        const opicoesFinais = $.extend({
            mensagem: 'Em breve!',
            horario: '23:59:59'
        }, opicoes);
        ...
        const mensagem = $('<div class="mensagem">').html(opicoesFinais.mensagem);
        ...
        const horarioAlvo = regex.exec(opicoesFinais.horario);
